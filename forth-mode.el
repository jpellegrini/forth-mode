...
(defvar forth-mode-map
  (let ((map (make-sparse-keymap)))
    ...
    (define-key map (kbd "C-c C-v")   'forth-eval-line)
    (define-key map (kbd "C-c C-b")   'forth-eval-lines)
...
(defvar forth-menu-entries
  (reverse (list
	    ...
	    '(eval-line    "Eval line"             forth-eval-line)
	    '(eval-lines   "Eval lines"            forth-eval-lines)
